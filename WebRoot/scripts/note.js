...
function sureAddNote(){
	...
	//发送请求
	$.ajax({
		url:"http://localhost:8080/cloudnote/note/add.do",
		type:"post",
...
function updateNote(){
	...
	//发送ajax请求
	$.ajax({
		url:"http://localhost:8080/cloudnote/note/update.do",
		type:"post",
...
function shareNote(){
	...
	//发送ajax请求
	$.ajax({
		url:"http://localhost:8080/cloudnote/note/share.do",
		type:"post",
		data:{"noteId":noteId},
		dataType:"json",
		success:function(result){
...
function showShare(){
	...
	//发送ajax请求
	$.ajax({
		url:"http://localhost:8080/cloudnote/note/loadShare.do",
		type:"post",
...
function recycleNoteList(){
	...
	//发送ajax请求
	$.ajax({
		url:"http://localhost:8080/cloudnote/note/loadDelete.do",
		type:"post",
		data:{"userId":userId},
		dataType:"json",
		success:function(result){
